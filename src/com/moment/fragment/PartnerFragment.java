package com.moment.fragment;

import java.util.ArrayList;
import java.util.List;

import com.moment.adapter.PostListAdapter;
import com.moment.info.PostInfo;
import com.moment.model.Model;
import com.moment.momentgo.LoginActivity;
import com.moment.momentgo.MainActivity;
import com.moment.momentgo.R;
import com.moment.momentgo.SendPostActivity;
import com.moment.momentgo.UploadActivity;
import com.moment.myview.MyListView;
import com.moment.myview.MyListView.OnRefreshListener;
...
public class PartnerFragment extends Fragment implements OnClickListener{
	...
	private PartnerFragmentCallBack mPartnerFragmentCallBack;
	private MyJson myJson = new MyJson();
	private List<PostInfo> list = new ArrayList<PostInfo>();
	...
	private void initView() {
		...
		mAdapter = new PostListAdapter(ctx, list);
		...
		ListBottem.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				if (flag && listBottemFlag) {
					url = Model.POST + "start=" + mStart + "$end=" + mEnd;
	...
	public void onClick(View arg0) {
		...
		switch (mID) {
		case R.id.Menu:
			mPartnerFragmentCallBack.callback(R.id.Menu);
			break;
	...
	public void setCallBack(PartnerFragmentCallBack mPartnerFragmentCallBack) {
		this.mPartnerFragmentCallBack = mPartnerFragmentCallBack;
	}
	
	public interface PartnerFragmentCallBack {
	...
	Handler hand = new Handler() {
		public void handleMessage(android.os.Message msg) {
			...
			if(msg.what == 404) {
				...
				if (result != null) {
					List<PostInfo> newList = myJson.getPostList(result);
					if (newList != null) {
						if (newList.size() == 5) {
