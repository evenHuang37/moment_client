...
import com.moment.momentgo.AshamedDetailActivity;
...
public class FollowFragment extends Fragment implements OnClickListener {
	...
	private FollowFragmentCallBack mFollowFragmentCallBack;
	...
	private void initView() {
		...
		mSendAshamed.setVisibility(View.GONE);
		...
		ListBottem.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				if (flag && listBottemFlag) {
					url = Model.FOLLOWLIST +  "auser=" + Model.MYUSERINFO.getUserid() + "&start=" + mStart + "&end=" + mEnd;
	...
	public void onClick(View arg0) {
		...
		switch (mID) {
		case R.id.Menu:
			mFollowFragmentCallBack.callback(R.id.Menu);
			break;
		case R.id.SendAshamed:
			mFollowFragmentCallBack.callback(R.id.SendAshamed);
			break;
		default:
			break;
		}
	...
	public void setCallBack(FollowFragmentCallBack mFollowFragmentCallBack) {
		this.mFollowFragmentCallBack = mFollowFragmentCallBack;
	}

	public interface FollowFragmentCallBack {
