...
public class Model {
	...
	public static String HTTPURL = "http://39.108.14.233/moment/";
	public static String INDEX = "index.php?";
	public static String POST = "post.php?";
	public static String ADDPOST = "addpost.php?";
	public static String ADDFOLLOW = "addfollow.php?";
	public static String DELFOLLOW = "delfollow.php?";
	public static String IFFOLLOW = "iffollow.php?";
	public static String GETUSER = "getuser.php?";
	public static String UPDATEINFO = "updateinfo.php?";
	public static String UPDATEPSW = "updatepsw.php?";
	public static String UPDATELIKE = "updatelike.php?";
	public static String FOLLOWLIST = "followlist.php?";
	public static String NICE = "nice.php?";
	...
	public static String USERHEADURL = "http://39.108.14.233/moment/Userimg/";
	public static String QIMGURL = "http://39.108.14.233/moment/Valueimg/";
	public static String HTTP_UPDATE_USERICON="updateUserIcon.php";
